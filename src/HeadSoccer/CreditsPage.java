...
class CreditsPage {
    public static Scene creditsscene()
    {
        ...
        Image bg = new Image(CreditsPage.class.getResource("/Resources/Background/bg.jpg").toString());
        ImageView bgv = new ImageView(bg);
        p.getChildren().add(bgv);

        Image creditss = new Image(CreditsPage.class.getResource("/Resources/Scenes/names.png").toString());
        ImageView creditssview = new ImageView(creditss);
        p.getChildren().add(creditssview);
